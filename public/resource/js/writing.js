    ...
    success: function (res) {
      ...
      const observer = {
        ...
        complete(res){
          console.log(res)
          // 写入自己的域名
          cb("http://s40gxf3hm.hb-bkt.clouddn.com/" + res.key)
          // http://s40gxf3hm.hb-bkt.clouddn.com/goblog/upload/1699795906176_3841471.jpg?token=d1sGMDPZmbTqqsap_IC21FfhuzoMM2OpJztMOcae:FblVyu_ovOr14cxSq3uHW-alrrI=:eyJzY29wZSI6Im15YmxvZ2dvIiwiZGVhZGxpbmUiOjE2OTk4MDMxMDZ9
        // http://s40gxf3hm.hb-bkt.clouddn.com/goblog/upload/1699793394827_3841471.jpg?e=1699796542&token=d1sGMDPZmbTqqsap_IC21FfhuzoMM2OpJztMOcae:d-tnl00MEvamQ22YH9nkrEIcdss=
        }
      }
